  ...
  return (
    <main className="min-h-screen px-6 pt-20 text-white from-black to-gray-900">
      <div className="max-w-lg mx-auto flex flex-col gap-6 sm:gap-8">
        <MenuCard
          onClick={() => navigate("/fueros/categorias/nacionales")}
        ...
        <MenuCard
          onClick={() => navigate("/fueros/categorias/federales")}
        ...
        <MenuCard
          onClick={() => navigate("/fueros/categorias/competencia-pais")}
...
function MenuCard({ onClick, title, icon, gradient }: any) {
  return (
    <motion.button
      type="button"
      onClick={onClick}
